...
export default function Analog() {
  ...
  const startTime = (timer.getConfig().startValues as number[]) || 0;
  const startTimeAsSeconds =
    startTime[1] * 60 + startTime[2] * 60 + startTime[3];

  const rotation =
    (360 / startTimeAsSeconds) *
    (startTimeAsSeconds - timer.getTotalTimeValues().seconds);
    ...
    <section className="container">
      ...
      <main className="container__content">
        ...
        >
          ...
          <g className="analog-clock__arm" style={{ rotate: `${rotation}deg` }}>
            <ellipse
              cx="7.98555"
              cy="7.9858"
              rx="7.98555"
            ...
            <rect
              ...
              height="125.223"
              rx="1.99639"
              transform="matrix(1 -7.0755e-09 0.00359053 0.999994 136.6 15.8)"
              fill="black"
            />
            <ellipse
              cx="4.98563"
            ...
            <rect
              ...
              height="125.223"
              rx="1"
              transform="matrix(1 -7.0755e-09 0.00359053 0.999994 137.55 14.78)"
              fill="#555555"
            />
          </g>
          <defs>
