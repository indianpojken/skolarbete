...
const ui = {
    ...
    button: document.querySelector('#get_insult'),
};
...
function getInsult() {
    ...
    if (!insults.length)
        insults = [...storedInsults];
}
window.onload = () => {
    var _a;
    (_a = ui === null || ui === void 0 ? void 0 : ui.button) === null || _a === void 0 ? void 0 : _a.addEventListener('click', () => { getInsult(); });
    getInsult();
};
